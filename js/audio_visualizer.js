...
*/
  ...
  var AudioVisualizer = function(width, height, requireOverview) {
    this.audioData = [];
    this.audioLength = 0;
    this.overview = [];
    this.stage = [];
    this.selectStart = 0;
    this.selectEnd = 0;
    this.requireOverview = requireOverview || false;
